...
from view.states import DelContacts
...
@dp.callback_query_handler(technik_menu_32.filter(level_t32='del_tg_data'))
async def del_user(call: CallbackQuery, admin: bool):
    """
    Переход в state удаления ID телеграмма пользователя
    """
