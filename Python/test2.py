# my_dict = {'1': ['1а', '2', '213'], '2': ['1б', '1', '103'], '3': ['1в', '1', '114']}

# def create_newcontact_human(our_dict: dict, num: int):
#     match num:
...
# create_newcontact_human(my_dict, 4)
# print(my_dict)

# user_input = list(my_dict.keys())
