...
num1 = int(input('Введите число N: '))
if num1 < 12:
    num2, num3 = (int(input(f'Введите номер строки (от 1 до {num1}): ')) - 1), (int(input(f'Введите номер второй строки (от 1 до {num1}): ')) - 1)
else:
    num2, num3 = (int(input('Введите номер строки (от 1 до 11): ')) - 1), int(input('Введите номер второй строки (от 1 до 11): ')) - 1
my_list = [random.randint(-num1, num1+1) for _ in range(num1)]
print((lambda x, y: x * y)(my_list[int(f1(num2))], my_list[int(f1(num3))]))
print(my_list)